...
import googlecloud from "../assets/portfolio/google.png";
import powerbi from "../assets/portfolio/powerbi.png";
import database from "../assets/portfolio/database.png";
        ...
        className='bg-gradient-to-b from-gray-800 to-black w-full h-screen '>
            <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'> 
                <div>
                    ...
                    <p className='py-6'> These are the technologies , I work in </p>
